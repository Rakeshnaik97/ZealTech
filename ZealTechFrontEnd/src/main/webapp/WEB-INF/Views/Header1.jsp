...
<body>
	...
	<div class="header" id="home1">
		<div class="container">
			...
			<div class="l_logo">
				<h1>
					<a href="index.html">Zeal Tech<span>Spirit Of Technology</span></a>
				</h1>
			</div>
			<div class="search">
			...
			<div class="cart cart box_1">
				<form action="#" method="post" class="last">
					...
					<button class="view-cart" type="submit" name="submit" value="">
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="ls_products_pos">
											<h4>
												<i>You Share We Care</i>
											</h4>
											<img src="${images}/Niit/Modal Banner Video/Iphone 8.jpg"
						...
						<li class="pages"><a href="#" class="dropdown-toggle"
