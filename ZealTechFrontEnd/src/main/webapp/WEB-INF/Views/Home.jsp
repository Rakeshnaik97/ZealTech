		...
		<div class="container">
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/Niit/New Products/R/200d.jpg" alt=" " class="img-responsive" />

						</div>
						<h5><a href="single.html">Canon 200d</a></h5>
						<div class="simpleCart_shelfItem">
							<p><span>£</span> <i class="item_price">£</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="ls_item" value="Red Laptop"> 
								<input type="hidden" name="amount" value="500.00">   
								<button type="submit" class="ls-cart">Add to cart</button>
							</form>
						</div>
					</div>
				</div>
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="${images}/Niit/New Products/R/iPhone-X.jpg" alt=" " class="img-responsive" /> 
							
							
						</div>
						<h5><a href="single.html">I Phone X</a></h5>
						<div class="simpleCart_shelfItem">
							<p><span>£</span> <i class="item_price">£</i></p>
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="ls_item" value="Black Phone"> 
					...
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<div class="simpleCart_shelfItem">
							...
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="ls_item" value="Kids Toy"> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							...
							<div class="_hs_bottom _hs_bottom_sub">
								<ul>
									<li>
						...
						<div class="simpleCart_shelfItem">
							...
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="add" value="1"> 
								<input type="hidden" name="ls_item" value="Induction Stove"> 
